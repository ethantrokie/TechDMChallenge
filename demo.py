...
def main(argv):
	...
	while input("Start?") == "y":
		print(
			"Hi, we want to get to know you a little bit better so we can place you with the best volunteer oppertunity!!\n")
		expected = ['Classroom language link volunteer', 'distribute groceries to those in need',
		            'Intake assistant for hopital', 'Visiting elderly at senior facility', 'ETHS science fair']
		predict_x = {
